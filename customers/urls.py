...
urlpatterns = patterns('',
    ...
    url(r'^customer/add_proyect/$', 'customers.views.addService', name='addService'), #Vista para contratar paquete desde pagina externa por medio de idmail pasado en url
